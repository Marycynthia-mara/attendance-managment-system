		...
		<div class="col-sm-8 col-md-6 col-lg-4">
			<div class="panel panel-success">
				...
				<div class="panel-heading">
					<h1 class="panel-title"><strong>Add Group Here!</strong></h1>
				</div>
				...
				<div class="panel-body signup_body">
					<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
						...
						<div class="form-group">
							<input class="form-control" type="text"  placeholder="Enter Group name here"  name="groupName" value="<?php  if(isset($groupName)){echo $groupName; } ?>">
						</div>

						<?php if (isset($errors['groupName']))  : ?>

			            <div class="form-group alert alert-danger">
			                <p><i>Group Name cannot be empty</i></p>
			            </div>
     					   <?php endif; ?>	

     					   <?php if (isset($errors['dublicate_groupName']))  : ?>

			            <div class="form-group alert alert-danger">
			                <p><i>Group Name already exist</i></p>
			            </div>
     					   <?php endif; ?>													
						...
						<div class="row signed">
							<div class="col-sm-offset-3 col-sm-6">
								<button class="btn btn-primary btn-lg btn-block" value="Add Event" id="submit" type="submit" name="addGroup">Add Group</button>
							</div>
				 ...
				 <?php if (isset($msg))  : ?>
			            ...
			            <div class="form-group alert alert-success">
			                <p><i>Group Added Successful</i></p>
			            </div>
     		   <?php endif; ?>
