...
if (isset($_POST['Search'])) {
	$result = find_search_result($_POST,  'course', 'course_name');
			...
			<h1>
				<div class="row">
					<div class="col-sm-8">
						...
						<img src="resources/table_icons/attributes_display.png">Found Course</a>
					</div>
...
<tbody>
		...
		<?php if (isset($msg)){
			...
			<tr>
				<td id="" class="students-name"><a href="admin_user_view.php?user_id=<?php echo $search_result['course_id'] ?>" style="display: block; padding:0px;"><?php echo $search_result['course_name']?></a></td>
			</tr>
		<?php	}} elseif(count($result) == count($result, COUNT_RECURSIVE)){ ?>
				<tr>
				<td id="" class="students-name"><a href="admin_user_view.php?user_id=<?php echo $result['course_id'] ?>" style="display: block; padding:0px;"><?php echo $result['course_name']?></a></td>
			</tr>
	<?php	} else{?>
		<tr>
