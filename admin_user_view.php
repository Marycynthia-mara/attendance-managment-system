...
if (isset($_POST['update_profile'])) {
	$userid = $_GET['user_id'];
	$result = update_profile($_POST, $userid);
	// extract($_POST);
    if ($result === true) {
        $msg = true;
    } else {
...
// }
 ...
 ?>
	...
	<div class="page-header">
		<?php 
		$userid = $_GET['user_id'];
		$all_users = fetch_user($userid); ?>
		<?php if ($all_users): ?>
		<h1>You are Viewing <?php echo $all_users['username']; ?>'s Profile</h1>
	</div>
	<div class="row">
		<div class="col-md-6">
			...
			<div class="panel panel-info">
				<div class="panel-body">
					<div class="form-group">
						<label><h1><?php echo $all_users['username']; ?>'s Details</h1></label>


		
						<div class="form-control-static"><b>Email Address :</b> <?php echo $all_users['email']; ?></div>
						<div class="form-control-static"><b>Fullname : </b><?php echo $all_users['fullname']; ?></div>
						<div class="form-control-static"><b>Reg No : </b><?php echo $all_users['reg_no']; ?></div>
						<div class="form-control-static"><b>Username : </b><?php echo $all_users['username']; ?></div>
						<div class="form-control-static"><b>Course : </b><?php echo $all_users['course_name']; ?></div>
						<div class="form-control-static"><b>Group : </b><?php echo $all_users['group_name'];; ?></div>
		<?php endif ?>
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					<h3 class="panel-title">
						...
						Update <?php echo $all_users['username']; ?>'s profile here	</h3>
				</div>
				<div class="panel-body">
					<form method="post" action="admin_user_view.php?user_id=<?php echo $_GET['user_id'] ;?>">
						...
						<div class="form-group">
							...
							<input type="hidden" name="$user_id" value="<?php echo urlencode($_GET['user_id']); ?>" >
