...
if (isset($_POST['Search'])) {
	$result = find_search_result($_POST,  'users', 'username');
			...
			<h1>
				<div class="row">
					<div class="col-sm-8">
						...
						<img src="resources/table_icons/group.png">Found User(s)</a>
					</div>
...
<tbody>
		...
		<?php if (isset($msg)){
			...
			<tr>
				<td id="" class="students-name"><a href="admin_user_view.php?user_id=<?php echo $search_result['user_id'] ?>" style="display: block; padding:0px;"><?php echo $search_result['username']?></a></td>
			</tr>
		<?php	} }else{ ?>
				<tr>
				<td id="" class="students-name"><a href="admin_user_view.php?user_id=<?php echo $result['user_id'] ?>" style="display: block; padding:0px;"><?php echo $result['username']?></a></td>
			</tr>
	<?php	} }else{?>
		<tr>
	...
	<!-- <tfoot><tr><td colspan=4>Records 1 to 5 of 5</td></tr></tfoot> -->
</table></div>
